    ...
    public class AuthResponseService : IAuthResponse
    {
        ...
        private async Task<JwtSecurityToken> CreateJwtAsync(AppUser user)
        {
            ...
            var jwtSecurityToken = new JwtSecurityToken(
                ...
                claims: claims,
                expires: DateTime.Now.AddMinutes((double)_Jwt.DurationInDays),
        ...
        public async Task<AuthResponse> RefreshTokenCheckAsync(string token)
        {
            ...
            var user = await _userManager.Users.Where(u => u.RefreshTokens != null && u.RefreshTokens.Any(t => t.Token == token)).FirstOrDefaultAsync();
        ...
        public async Task<string> ConfirmEmailAsync(string userId, string code)
        {
            ...
            {
                throw new Exception($"An error occured while confirming email.");
            }
        }
